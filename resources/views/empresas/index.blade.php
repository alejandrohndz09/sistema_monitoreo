                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody id="tableBody">
                                        @foreach ($empresas as $c)
                                            <tr class="tr-link" data-id="{{ $c->idEmpresa }}">
                                                <td style="width: 9%">
                                                    <div
                                                ...
                                                <td>
                                                    @if ($c->estado == 1)
                                                        @if ($c->usuarios->isEmpty())
                                                            <a role="button" data-id="{{ $c->idEmpresa }}"
                                                                data-bs-tt="tooltip"
                                                                data-bs-original-title="Enviar Credenciales"
                                                                class="btnCredencial me-3">
                                                                <i class="fas fa-user-shield text-secondary"></i>
                                                            </a>
                                                        @endif
                                                        <a role="button" data-bs-toggle="modal" data-bs-target="#modalForm"
                                                            data-id="{{ $c->idEmpresa }}" data-bs-tt="tooltip"
                                                            data-bs-original-title="Editar" class="btnEditar me-3">
                                                            <i class="fas fa-pen text-secondary"></i>
                                                        </a>

                                                        <a role="button" data-bs-toggle="modal"
                                                            data-bs-target="#modalConfirm" data-id="{{ $c->idEmpresa }}"
